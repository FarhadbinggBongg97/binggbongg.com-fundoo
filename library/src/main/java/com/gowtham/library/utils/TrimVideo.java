...
public class TrimVideo {
    ...
    public static final class ActivityBuilder {
        ...
        public void start(Activity activity) {
            validate();
            activity.startActivityForResult(getIntent(activity), VIDEO_TRIMMER_CODE);
        }

        public void start(Fragment fragment) {
            validate();
            fragment.startActivityForResult(getIntent(fragment.getActivity()), VIDEO_TRIMMER_CODE);
        }
