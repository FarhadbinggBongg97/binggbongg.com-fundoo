...
public class ActVideoTrimmer extends AppCompatActivity {
    ...
    private void setDataInView() {
        try {
            ...
            Toast.makeText(this, "Ca`nnot trim that file", Toast.LENGTH_SHORT).show();
            finish();
        }
    }
    ...
    private void trimVideo() {
        ...
        if (isValidVideo) {
            ...
            outputPath = "/storage/emulated/0/Android/data/com.app.binggbongg/files/Temp/videorecord.mp4";
    ...
    private void execFFmpegBinary(final String[] command, boolean retry) {
        try {
            Log.e(TAG, "execFFmpegBinary: :::::::::::"+ Arrays.toString(command) );

            FFmpeg.executeAsync(command, (executionId1, returnCode) -> {
                if (returnCode == RETURN_CODE_SUCCESS) {
                    /*dialog.dismiss();*/
                    pdLoading.dismiss();
                    setResult(VIDEO_TRIMMER_CODE);
                    finish();
                    ...
                    Log.e(TAG, "execFFmpegBinary: return code::::::::::::::;;"+returnCode );
    ...
    private String[] getAccurateCmd() {
        Log.e(TAG, "getAccurateCmd: :::::::"+uri+":::::::::"+outputPath);
        return new String[]{"-ss", TrimmerUtils.formatCSeconds(lastMinValue)
    ...
    private void showProcessingDialog() {
        try {
            ...
            pdLoading = new ProgressDialog(ActVideoTrimmer.this, R.style.CameraAlertDialog);
    ...
    Runnable updateSeekbar = new Runnable() {
        ...
        public void run() {
            try {
                ...
                Log.i(TAG, "totalDurationDuration=> " + videoPlayer.getContentDuration());
                Log.i(TAG, "lastMaxValue=> " + lastMaxValue);
                ...
                seekHandler.postDelayed(updateSeekbar, 500);
            }
        }
    };
