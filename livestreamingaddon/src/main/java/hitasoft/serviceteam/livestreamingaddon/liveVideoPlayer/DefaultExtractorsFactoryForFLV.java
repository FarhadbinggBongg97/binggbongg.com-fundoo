    ...
    public DefaultExtractorsFactoryForFLV() {
        synchronized (DefaultExtractorsFactory.class) {
            if (defaultExtractorClasses == null) {
                ...
                try {
                    /*extractorClasses.add(FlvExtractor.FACTORY.createExtractors()[0].getClass());*/
                    extractorClasses.add(Class.forName("com.google.android.exoplayer2.extractor.flv.FlvExtractor")
                            .asSubclass(Extractor.class));
