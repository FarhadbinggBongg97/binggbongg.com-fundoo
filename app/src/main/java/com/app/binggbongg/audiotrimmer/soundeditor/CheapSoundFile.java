...
package com.app.binggbongg.audiotrimmer.soundeditor;



import com.app.binggbongg.audiotrimmer.SelectionPoint;
...
public class CheapSoundFile {
    ...
    public void SaveCache(String filePath ) throws IOException {
        ...
        //File WaveFormFile = new File(StorageUtils.getInstance().instance.getCacheDir(), filePath.hashCode()+"");
