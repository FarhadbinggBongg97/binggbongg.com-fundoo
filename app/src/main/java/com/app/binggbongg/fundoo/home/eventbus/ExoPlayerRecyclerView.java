...
import com.app.binggbongg.fundoo.VideoScrollFragment;
...
public class ExoPlayerRecyclerView extends RecyclerView implements DownloadListener {
                ...
                switch (playbackState) {
                    ...
                    case Player.STATE_ENDED:
                        ...
                        if (isAutoScroll) {
                            ...
                            videoPlayer.seekTo(0);
                            if(VideoScrollFragment.giftDialog!=null && VideoScrollFragment.giftDialog.isShowing()){
                                VideoScrollFragment.giftDialog.dismiss();
                            }

                            if (VideoScrollFragment.hideBottomBarBS != null &&
                                    VideoScrollFragment.hideBottomBarBS.isShowing()) {
                                VideoScrollFragment.hideBottomBarBS.dismiss();
                            }
...
//                reverseTime.setText((videoPlayer.getCurrentPosition()/videoPlayer.getDuration())*100);
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        VideoScrollFragment.VideoAdapter.VideoViewHolder holder = (VideoScrollFragment.VideoAdapter.VideoViewHolder) child.getTag();
