...
public class GPUImageLookUpTableFilter extends GPUImageFilter {
   ...
   /* public GPUImageLookUpTableFilter(Bitmap bitmap) {
   ...
   /* public GPUImageLookUpTableFilter(Resources resources, int fxID) {
