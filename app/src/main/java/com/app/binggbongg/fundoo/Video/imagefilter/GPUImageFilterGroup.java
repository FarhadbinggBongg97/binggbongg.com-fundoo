...
package com.app.binggbongg.fundoo.Video.imagefilter;
...
public class GPUImageFilterGroup extends GPUImageFilter {
    ...
    public void updateMergedFilters() {
        ...
        for (GPUImageFilter filter : this.filters) {
            if (filter instanceof jp.co.cyberagent.android.gpuimage.filter.GPUImageFilterGroup) {
                ((jp.co.cyberagent.android.gpuimage.filter.GPUImageFilterGroup) filter).updateMergedFilters();
                filters = ((jp.co.cyberagent.android.gpuimage.filter.GPUImageFilterGroup) filter).getMergedFilters();
