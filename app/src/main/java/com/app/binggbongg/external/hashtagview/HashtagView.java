...
public class HashtagView extends LinearLayout {
     ...
     * @param transformer Implementation of {@link com.app.binggbongg.external.hashtagview.HashtagView.DataTransform}  or
     *                    {@link com.app.binggbongg.external.hashtagview.HashtagView.DataStateTransform}
     ...
     *                    interface. Can be used for building label from several custom data model
     *                    fields or to prepare {@link android.text.Spannable} label representation.
     * @param selector    Implementation of {@link com.app.binggbongg.external.hashtagview.HashtagView.DataSelector}
     ...
     *
     * @param listener {@link com.app.binggbongg.external.hashtagview.HashtagView.TagsClickListener}
     */
     ...
     *
     * @param listener {@link com.app.binggbongg.external.hashtagview.HashtagView.TagsSelectListener}
     */
...
//            backgroundDrawable = a.getResourceId(R.styleable.HashtagView_tagBackground, 0);
            backgroundDrawable = R.drawable.rounded_solid_primary;
    ...
    private View inflateItemView(final ItemData item) {
        ViewGroup itemLayout = (ViewGroup) LayoutInflater.from(getContext()).inflate(R.layout.item_hashtag_view, this, false);
