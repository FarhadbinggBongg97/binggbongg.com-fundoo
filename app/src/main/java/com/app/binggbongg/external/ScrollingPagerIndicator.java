...
public class ScrollingPagerIndicator extends View {
    ...
    public interface PagerAttacher<T> {
         ...
         * You must call:
         * {@link com.app.binggbongg.external.ScrollingPagerIndicator#setDotCount(int)} - initially and after page selection,
         * {@link com.app.binggbongg.external.ScrollingPagerIndicator#setCurrentPosition(int)} - initially and after page selection,
         * {@link com.app.binggbongg.external.ScrollingPagerIndicator#onPageScrolled(int, float)} - in your pager callback to track scroll offset,
         * {@link com.app.binggbongg.external.ScrollingPagerIndicator#reattach()} - each time your adapter items change.
         *
         * @param indicator indicator
         * @param pager pager to attach
         */
        void attachToPager(@NonNull com.app.binggbongg.external.ScrollingPagerIndicator indicator, @NonNull T pager);
