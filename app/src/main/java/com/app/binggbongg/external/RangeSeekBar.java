...
public class RangeSeekBar<T extends Number> extends ImageView {
     ...
     */
    public static final int DEFAULT_COLOR = Color.argb(0xFF, 0xFF, 0x40, 0x81);
    /**
    ...
    private final Bitmap thumbImage = getRoundedCroppedBitmap();
    private final Bitmap thumbPressedImage =getRoundedCroppedBitmap();
    ...
    public  Bitmap getRoundedCroppedBitmap() {

        Bitmap output = Bitmap.createBitmap(42,
                42, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(output);

        final Paint paint = new Paint();
        final Rect rect = new Rect(0, 0, output.getWidth(),
                output.getHeight());
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        paint.setColor(Color.parseColor("#e1e8eb"));
        paint.setAntiAlias(true);
