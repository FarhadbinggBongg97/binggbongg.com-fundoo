...
package com.app.binggbongg.apprtc;
...
public class AppRTCAudioManager {
    ...
    private void setAudioDeviceInternal(AudioDevice device) {
        ...
        Log.d(TAG, "setAudioDeviceInternal: " + new Gson().toJson(audioDevices));
            ...
            for (AudioDeviceInfo device : devices) {
                ...
                switch (type) {
                    case AudioDeviceInfo.TYPE_WIRED_HEADSET:
                        Log.d(TAG, "hasWiredHeadset: found TYPE_WIRED_HEADSET");
                        audioOutput = AudioDeviceInfo.TYPE_WIRED_HEADSET;
                        hasWiredHeadset = true;
                        return true;
                    case AudioDeviceInfo.TYPE_WIRED_HEADPHONES:
                        Log.d(TAG, "hasWiredHeadset: found TYPE_WIRED_HEADPHONES");
                        audioOutput = AudioDeviceInfo.TYPE_WIRED_HEADPHONES;
                        hasWiredHeadset = true;
                        return true;
                    case AudioDeviceInfo.TYPE_BLUETOOTH_SCO:
                        Log.d(TAG, "hasWiredHeadset: found TYPE_BLUETOOTH_SCO");
                        audioOutput = AudioDeviceInfo.TYPE_BLUETOOTH_SCO;
                        hasWiredHeadset = false;
                        return true;
                    case AudioDeviceInfo.TYPE_BLUETOOTH_A2DP:
                        Log.d(TAG, "hasWiredHeadset: found TYPE_BLUETOOTH_A2DP");
                        audioOutput = AudioDeviceInfo.TYPE_BLUETOOTH_A2DP;
                        hasWiredHeadset = false;
                        return true;
                    case AudioDeviceInfo.TYPE_USB_DEVICE:
                        Log.d(TAG, "hasWiredHeadset: found TYPE_USB_DEVICE");
                        audioOutput = AudioDeviceInfo.TYPE_USB_DEVICE;
                        hasWiredHeadset = false;
                        return true;
                }
            }
    ...
    public void updateAudioDeviceState() {
        ...
        Log.i(TAG, "updateAudioDeviceState: " + hasWiredHeadset);
        Log.i(TAG, "updateAudioDeviceState: " + defaultAudioDevice);
        if (bluetoothManager.getState() == AppRTCBluetoothManager.State.SCO_CONNECTED) {
